...
suite('Union Types', () => {
	...
	test('Union type (2)', async () => {
		...
		const validate: Element[] = [
			...
			JSON.parse('{"id":154,"type":"edge","label":"item","outV":152,"inVs":[69,82],"shard":2,"property":"referenceResults"}'),
	...
	test('Union type (3)', async () => {
		...
		const validate: Element[] = [
			...
			JSON.parse('{"id":182,"type":"edge","label":"item","outV":180,"inVs":[85,98],"shard":2,"property":"referenceResults"}'),

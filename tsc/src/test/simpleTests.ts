...
suite('Simple Tests', () => {
	test('Single export', () => {
		...
		const validate: Element[] = [
			...
			JSON.parse('{"id":15,"type":"vertex","label":"range","start":{"line":0,"character":13},"end":{"line":0,"character":14},"tag":{"type":"definition","text":"x","kind":7,"fullRange":{"start":{"line":0,"character":13},"end":{"line":0,"character":19}}}}')
		];

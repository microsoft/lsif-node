...
import {
	...
	Moniker, PackageInformation, ItemEdgeProperties, E1N, E11, Event, EventScope, EventKind
} from 'lsif-protocol';
...
const eventCompressor = new GenericCompressor<Event>(vertexCompressor, Compressor.nextId(), (next) => [
